...
import { UtkMap, LayerType, ILayerThematic, ThematicAggregationLevel, MapEvent } from 'utkmap';

export class MapD3 {
  protected db!: SpatialDb;
  protected map!: UtkMap;
  protected plot!: UtkPlotD3;
  ...
  protected async loadUtkPlot() {
    ...
    this.plot = new UtkPlotD3(plotBdy, this.d3Spec(), [PlotEvent.BRUSH]);
  ...
  ): [SVGSVGElement, SVGCircleElement[]] {
