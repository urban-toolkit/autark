...
@fragment
fn main(@builtin(position) fragPos: vec4f, @location(0) inNormal: vec3f, @location(1) inThematic: f32, @location(2) inHighlighted: f32, @location(3) inThematicValid: f32, @location(4) inSkipped: f32) -> BufferOut {
